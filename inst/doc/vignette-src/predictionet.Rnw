...
As can be seen, few interactions have been previously reported; this maybe due to the fact that the genes reported in \citep{bild2006oncogenic} have been poorly characterized so far.
